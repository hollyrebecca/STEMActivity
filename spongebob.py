...
def draw_oval(t, x, y, r, fill, border="black", pensize=3):
    t.penup()
    t.goto(x, y - r) # Center the circle at (x, y)
    t.setheading(0)
    t.pensize(pensize)
...
draw_circle(t, -75, 120, 10, "#CCD122", border="#CCD122")
draw_circle(t, -78, 90, 5, "#CCD122", border="#CCD122")
draw_circle(t, 85, 130, 7, "#CCD122", border="#CCD122")
draw_circle(t, -70, -15, 10, "#CCD122", border="#CCD122")
draw_circle(t, -80, 5, 6, "#CCD122", border="#CCD122")
draw_circle(t, 80, -5, 10, "#CCD122", border="#CCD122")
draw_circle(t, 60, -20, 6, "#CCD122", border="#CCD122")
...
# Black Shoes
draw_circle(t, -45, -172, 10, "black")
draw_oval(t, -61, -169, 9, "black")
draw_oval(t, -68, -169, 9, "black")
draw_circle(t, -72, -172, 11, "black")
draw_rect(t, -47, -173, 10, 10, "black")

draw_circle(t, 43, -172, 10, "black")
draw_oval(t, 46, -169, 9, "black")
draw_oval(t, 53, -169, 9, "black")
draw_circle(t, 70, -172, 11, "black")
draw_rect(t, 36, -173, 10, 10, "black")

# 4. Arms and Hands
# Sleeves
draw_rect(t, -115, -10, 15, 20, "white")
draw_rect(t, 100, -10, 15, 20, "white")
# Yellow Arms
draw_rect(t, -111, -30, 7, 55, "#FFF200")
draw_rect(t, 104, -30, 7, 55, "#FFF200")
# Fingers
draw_rect(t, -115, -90, 7, 20, "#FFF200")
draw_rect(t, 108, -90, 7, 20, "#FFF200")
# Hands
draw_circle(t, -108, -90, 9, "#FFF200")
draw_circle(t, 108, -90, 9, "#FFF200")
# Thumb
draw_rect(t, -111, -90, 7, 15, "#FFF200")
t.teleport(-111,-90)
t.color( "#FFF200")
t.forward(7)
draw_rect(t, 104, -90, 7, 15, "#FFF200")
t.teleport(104,-90)
t.color( "#FFF200")
t.forward(7)
t.color("black")
